...
public class VendingMachine {
    ...
    private BuisnessLogic buisnessFacade;
    ...
    public VendingMachine(Cents[] coinKinds, int selectionButtonCount, int coinRackCapacity, int productRackCapacity, int receptacleCapacity) {
        ...
        this.productFacade = new ProductsFacade(this);
        this.buisnessFacade = new BuisnessLogic(paymentFacade, communicationFacade, productFacade);
    }
